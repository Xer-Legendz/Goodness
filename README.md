    ...
    <div class="container">
      ...
      <div class="projects-grid">
        <div class="project-card">
          <h3>Project 1</h3>
          <p>A modern responsive website for a local business.</p>
        </div>
        <div class="project-card">
          <h3>Project 2</h3>
          <p>An interactive dashboard built with JavaScript and APIs.</p>
        </div>
        <div class="project-card">
          <h3>Project 3</h3>
          <p>A personal blog platform with a clean, minimal design.</p>
        </div>
      </div>
    </div>
  </section>
